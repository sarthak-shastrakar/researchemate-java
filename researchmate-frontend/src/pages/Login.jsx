...
import {
  BookOpen, Mail, Lock, ArrowRight, Loader2, AlertCircle,
    ...
    <div className="min-h-screen flex">
        ...
        <div className="relative z-10 space-y-10">
          <div className="space-y-4">
            ...
            <h2 className="text-[2.6rem] font-extrabold text-white leading-tight">
              Turn the web into your personal knowledge&nbsp;base
            </h2>
            <p className="text-indigo-200 text-base leading-relaxed max-w-sm">
              Save sources, generate summaries, ask AI questions — all grounded in your own research.
            </p>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 lg:px-16 bg-white">
        <div className="w-full max-w-md">
          ...
          {/* Top logo — always visible (small on desktop since panel shows branding) */}
          ...
          {isExpired && !error && (
            ...
            >
              ...
              <p className="text-sm font-medium text-amber-800">Your session has expired. Please log in again.</p>
            </div>
          )}
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center">
              <span className="bg-white px-4 text-xs text-gray-400">New to ResearchMate?</span>
            </div>
          </div>
